...
graph LR
  ...
  class n_moz_cyclones,n_moz_cholera,n_lac_dry_corridor,n_hti_hurricanes,n_cub_hurricanes,n_mmr_cyclones,n_fji_storms framework;
  class n_hti_hurricanes_monitoring,n_hurricanes_monitoring,n_ken_drought_monitoring,n_rosea_thresholds_monitoring,n_mdg_monitoring,n_ven_earthquake_support,n_glb_tropicalcyclones,n_floodscan_ingest,n_storm_impact_harmonisation,n_moz_cholera_monitoring,n_floodexposure_monitoring,n_flood_gfm,n_fms_tc_outlook,n_storms_alerts,n_moz_cyclones_monitoring,n_cerf_supplement,n_seasonal_bulletin,n_afro_cholera,n_teleconnections,n_imerg,n_hdx_signals,n_glb_cyclones_impactmodel,n_raster_stats,n_nhc_forecast,n_storms_pipeline,n_eth_drought_monitoring,n_raster_pipelines pipeline;
  class n_seas5_viz,n_fji_storms_app,n_data_validation_app,n_raster_stats_app,n_chd_pa_aa_nga_cholera,n_chd_ds_geospatial_impact_viewer,n_cerf_global_trigger_allocations_app,n_seas5_skill,n_storm_exposure_compare,n_floodexposure_monitoring_app,n_chd_ds_aa_hti_hurricanes_app,n_cerf_3rm_app,n_hti_hurricanes_app,n_geospatial_impact_exposure app;
  class n_som_risk_analysis_support,n_cmr_flooding_support,n_rosea_thresholds,n_fts_us_award_funding,n_nga_cholera,n_ibtracs_matching,n_contingency_hurricanes analysis;
  class n_storms_ibtracs_tracks_geo,n_app_floodscan_exposure,n_public_imerg,n_public_floodscan,n_app_quantile_regions,n_public_qa,n_public_iso3,n_storms_nhc_storms,n_app_floodscan_exposure_regions,n_app_quantile,n_public_polygon,n_storms_nhc_tracks_geo,n_app_admin_lookup,n_public_seas5,n_app_adm,n_storms_ibtracs_storms,n_public_era5,n_storms_ecmwf_storms,n_storms_ecmwf_tracks_geo table;
  class n_listmonk,n_aws_smtp,n_dbx_job_compute infra;
  class n_cerf_onegms,n_gfm_stac,n_ghsl,n_worldpop,n_ipc,n_hnrp external;
```
