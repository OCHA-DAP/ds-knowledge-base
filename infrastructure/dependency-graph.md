...
graph LR
  ...
  class n_fji_storms,n_lac_dry_corridor,n_cub_hurricanes,n_moz_cholera,n_hti_hurricanes,n_moz_cyclones,n_mdg_storms,n_mmr_cyclones framework;
  class n_moz_cyclones_monitoring,n_ken_drought_monitoring,n_cerf_supplement,n_moz_cholera_monitoring,n_floodexposure_monitoring,n_hurricanes_monitoring,n_mdg_monitoring,n_nhc_forecast,n_rosea_thresholds_monitoring,n_raster_stats,n_fms_tc_outlook,n_teleconnections,n_storms_alerts,n_glb_tropicalcyclones,n_floodscan_ingest,n_hti_hurricanes_monitoring,n_hdx_signals,n_imerg,n_afro_cholera,n_flood_gfm,n_eth_drought_monitoring,n_ven_earthquake_support,n_seasonal_bulletin,n_raster_pipelines,n_storms_pipeline,n_storm_impact_harmonisation,n_glb_cyclones_impactmodel pipeline;
  class n_hti_hurricanes_app,n_geospatial_impact_exposure,n_fji_storms_app,n_chd_pa_aa_nga_cholera,n_seas5_skill,n_raster_stats_app,n_seas5_viz,n_cerf_global_trigger_allocations_app,n_cerf_3rm_app,n_data_validation_app,n_storm_exposure_compare,n_floodexposure_monitoring_app,n_chd_ds_geospatial_impact_viewer,n_chd_ds_aa_hti_hurricanes_app app;
  class n_nga_cholera,n_cmr_flooding_support,n_contingency_hurricanes,n_som_risk_analysis_support,n_rosea_thresholds,n_fts_us_award_funding,n_ibtracs_matching analysis;
  class n_app_admin_lookup,n_app_floodscan_exposure_regions,n_public_floodscan,n_storms_ibtracs_tracks_geo,n_public_imerg,n_public_iso3,n_storms_ecmwf_storms,n_public_polygon,n_app_adm,n_app_quantile_regions,n_public_seas5,n_storms_ecmwf_tracks_geo,n_app_floodscan_exposure,n_public_era5,n_storms_ibtracs_storms,n_storms_nhc_storms,n_public_qa,n_app_quantile,n_storms_nhc_tracks_geo table;
  class n_dbx_job_compute,n_aws_smtp,n_listmonk infra;
  class n_hnrp,n_ipc,n_gfm_stac,n_worldpop,n_cerf_onegms,n_ghsl external;
```
