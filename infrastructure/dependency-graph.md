...
graph LR
  ...
  class n_hti_hurricanes,n_mdg_storms,n_lac_dry_corridor,n_mmr_cyclones,n_moz_cholera,n_moz_cyclones,n_cub_hurricanes,n_fji_storms,n_nga_flooding framework;
  class n_storm_impact_harmonisation,n_imerg,n_mdg_monitoring,n_storms_pipeline,n_ken_drought_monitoring,n_glb_tropicalcyclones,n_moz_cyclones_monitoring,n_floodscan_ingest,n_aa_tracking,n_teleconnections,n_hurricanes_monitoring,n_cems_flood_archive,n_storms_alerts,n_cerf_supplement,n_raster_pipelines,n_fms_tc_outlook,n_eth_drought_monitoring,n_nga_flooding_monitoring,n_hdx_signals,n_nhc_forecast,n_raster_stats,n_ven_earthquake_support,n_floodexposure_monitoring,n_glb_cyclones_impactmodel,n_seasonal_bulletin,n_flood_gfm,n_hti_hurricanes_monitoring,n_afro_cholera,n_moz_cholera_monitoring,n_rosea_thresholds_monitoring pipeline;
  class n_cerf_global_trigger_allocations_app,n_seas5_viz,n_storm_exposure_compare,n_chd_ds_geospatial_impact_viewer,n_seas5_skill,n_data_validation_app,n_hti_hurricanes_app,n_chd_ds_aa_hti_hurricanes_app,n_raster_stats_app,n_floodexposure_monitoring_app,n_geospatial_impact_exposure,n_fji_storms_app,n_chd_pa_aa_nga_cholera,n_cerf_3rm_app app;
  class n_external_aa_frameworks_review,n_rosea_thresholds,n_som_risk_analysis_support,n_nga_cholera,n_contingency_hurricanes,n_ibtracs_matching,n_cmr_flooding_support,n_fts_us_award_funding,n_uga_drought_flood_2026 analysis;
  class n_app_floodscan_exposure_regions,n_app_floodscan_exposure,n_storms_ecmwf_storms,n_storms_nhc_storms,n_public_qa,n_app_quantile_regions,n_storms_ibtracs_tracks_geo,n_app_admin_lookup,n_app_adm,n_public_iso3,n_public_floodscan,n_storms_ibtracs_storms,n_public_seas5,n_app_quantile,n_public_imerg,n_storms_ecmwf_tracks_geo,n_public_polygon,n_storms_nhc_tracks_geo,n_public_era5 table;
  class n_listmonk,n_dbx_job_compute,n_aws_smtp infra;
  class n_ocha_lens,n_hnrp,n_ipc,n_worldpop,n_gfm_stac,n_cerf_onegms,n_ghsl external;
```
