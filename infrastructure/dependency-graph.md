...
| [`raster-pipelines`](../pipelines/raster-pipelines.md) | pipeline | 3 | 21 | `cmr-flooding-support`, `eth-drought-monitoring`, `external-aa-frameworks-review`, `glb-tropicalcyclones`, `mdg-monitoring`, `mdg-storms`, `public.era5`, `public.floodscan`, `public.imerg`, `public.iso3`, `public.polygon`, `public.qa`, `public.seas5`, `raster-stats`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `som-risk-analysis-support`, `teleconnections`, `uga-drought-flood-2026` |
...
| [`public.iso3`](db-schema.md#public) | table | 2 | 20 | `eth-drought-monitoring`, `external-aa-frameworks-review`, `glb-tropicalcyclones`, `mdg-monitoring`, `mdg-storms`, `public.era5`, `public.floodscan`, `public.imerg`, `public.iso3`, `public.polygon`, `public.qa`, `public.seas5`, `raster-stats`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `som-risk-analysis-support`, `teleconnections`, `uga-drought-flood-2026` |
| [`raster-stats`](../pipelines/raster-stats.md) | pipeline | 10 | 20 | `eth-drought-monitoring`, `external-aa-frameworks-review`, `glb-tropicalcyclones`, `mdg-monitoring`, `mdg-storms`, `public.era5`, `public.floodscan`, `public.imerg`, `public.iso3`, `public.polygon`, `public.qa`, `public.seas5`, `raster-stats`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `som-risk-analysis-support`, `teleconnections`, `uga-drought-flood-2026` |
| [`Listmonk (comms)`](comms-listmonk.md) | infra | 14 | 18 | `afro-cholera`, `cerf-3rm-app`, `eth-drought-monitoring`, `fji-storms`, `fji-storms-app`, `fms-tc-outlook`, `ken-drought-monitoring`, `mdg-monitoring`, `mdg-storms`, `mmr-cyclones`, `moz-cholera`, `moz-cholera-monitoring`, `nga-flooding`, `nga-flooding-monitoring`, `rosea-thresholds-monitoring`, `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
...
| [`storms.ibtracs_storms`](db-schema.md#storms) | table | 4 | 7 | `aa-tracking`, `cerf-3rm-app`, `cerf-supplement`, `glb-tropicalcyclones`, `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
...
| [`public.imerg`](db-schema.md#public) | table | 3 | 4 | `glb-tropicalcyclones`, `mdg-monitoring`, `mdg-storms`, `raster-stats-app` |
...
graph LR
  ...
  class n_moz_cholera,n_mmr_cyclones,n_moz_cyclones,n_hti_hurricanes,n_nga_flooding,n_mdg_storms,n_lac_dry_corridor,n_fji_storms,n_cub_hurricanes framework;
  class n_ven_earthquake_support,n_eth_drought_monitoring,n_hti_hurricanes_monitoring,n_fms_tc_outlook,n_imerg,n_raster_pipelines,n_moz_cholera_monitoring,n_hurricanes_monitoring,n_moz_cyclones_monitoring,n_glb_cyclones_impactmodel,n_glb_tropicalcyclones,n_floodscan_ingest,n_cerf_supplement,n_floodexposure_monitoring,n_raster_stats,n_hdx_signals,n_nhc_forecast,n_teleconnections,n_aa_tracking,n_nga_flooding_monitoring,n_mdg_monitoring,n_afro_cholera,n_seasonal_bulletin,n_storm_impact_harmonisation,n_storms_pipeline,n_storms_alerts,n_ken_drought_monitoring,n_rosea_thresholds_monitoring,n_flood_gfm pipeline;
  class n_cerf_global_trigger_allocations_app,n_floodexposure_monitoring_app,n_chd_ds_aa_hti_hurricanes_app,n_chd_pa_aa_nga_cholera,n_cerf_3rm_app,n_fji_storms_app,n_storm_exposure_compare,n_data_validation_app,n_hti_hurricanes_app,n_seas5_viz,n_raster_stats_app,n_geospatial_impact_exposure,n_seas5_skill,n_chd_ds_geospatial_impact_viewer app;
  class n_uga_drought_flood_2026,n_external_aa_frameworks_review,n_contingency_hurricanes,n_fts_us_award_funding,n_ibtracs_matching,n_nga_cholera,n_cmr_flooding_support,n_som_risk_analysis_support,n_rosea_thresholds analysis;
  class n_app_adm,n_app_quantile,n_storms_ibtracs_storms,n_storms_nhc_tracks_geo,n_public_floodscan,n_app_floodscan_exposure_regions,n_storms_ibtracs_tracks_geo,n_storms_nhc_storms,n_storms_ecmwf_storms,n_app_admin_lookup,n_storms_ecmwf_tracks_geo,n_public_iso3,n_public_polygon,n_app_quantile_regions,n_public_seas5,n_public_imerg,n_app_floodscan_exposure,n_public_era5,n_public_qa table;
  class n_listmonk,n_dbx_job_compute,n_aws_smtp infra;
  class n_ghsl,n_ipc,n_worldpop,n_hnrp,n_gfm_stac,n_cerf_onegms external;
```
...
| [`Listmonk (comms)`](comms-listmonk.md) | infra | — | `afro-cholera`, `eth-drought-monitoring`, `fji-storms`, `fms-tc-outlook`, `ken-drought-monitoring`, `mdg-monitoring`, `mmr-cyclones`, `moz-cholera`, `moz-cholera-monitoring`, `nga-flooding`, `nga-flooding-monitoring`, `rosea-thresholds-monitoring`, `storm-impact-harmonisation`, `storms-alerts` |
