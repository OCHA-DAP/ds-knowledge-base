...
graph LR
  ...
  class n_moz_cholera,n_lac_dry_corridor,n_mdg_storms,n_hti_hurricanes,n_moz_cyclones,n_fji_storms,n_mmr_cyclones,n_nga_flooding,n_cub_hurricanes framework;
  class n_glb_cyclones_impactmodel,n_ken_drought_monitoring,n_floodscan_ingest,n_hurricanes_monitoring,n_fms_tc_outlook,n_imerg,n_ven_earthquake_support,n_afro_cholera,n_nhc_forecast,n_floodexposure_monitoring,n_cerf_supplement,n_aa_tracking,n_raster_pipelines,n_moz_cholera_monitoring,n_teleconnections,n_raster_stats,n_storm_impact_harmonisation,n_hti_hurricanes_monitoring,n_flood_gfm,n_storms_pipeline,n_cems_flood_archive,n_hdx_signals,n_seasonal_bulletin,n_nga_flooding_monitoring,n_storms_alerts,n_eth_drought_monitoring,n_glb_tropicalcyclones,n_mdg_monitoring,n_rosea_thresholds_monitoring,n_moz_cyclones_monitoring pipeline;
  class n_storm_exposure_compare,n_data_validation_app,n_cerf_global_trigger_allocations_app,n_chd_ds_geospatial_impact_viewer,n_floodexposure_monitoring_app,n_chd_ds_aa_hti_hurricanes_app,n_chd_pa_aa_nga_cholera,n_raster_stats_app,n_seas5_viz,n_hti_hurricanes_app,n_seas5_skill,n_fji_storms_app,n_cerf_3rm_app,n_geospatial_impact_exposure app;
  class n_external_aa_frameworks_review,n_fts_us_award_funding,n_nga_cholera,n_cmr_flooding_support,n_contingency_hurricanes,n_uga_drought_flood_2026,n_rosea_thresholds,n_ibtracs_matching,n_som_risk_analysis_support analysis;
  class n_storms_nhc_storms,n_storms_ibtracs_storms,n_app_quantile_regions,n_public_seas5,n_storms_nhc_tracks_geo,n_app_floodscan_exposure_regions,n_public_polygon,n_app_admin_lookup,n_app_floodscan_exposure,n_public_floodscan,n_storms_ecmwf_tracks_geo,n_public_qa,n_public_imerg,n_public_era5,n_storms_ibtracs_tracks_geo,n_storms_ecmwf_storms,n_public_iso3,n_app_adm,n_app_quantile table;
  class n_dbx_job_compute,n_aws_smtp,n_listmonk infra;
  class n_gfm_stac,n_ghsl,n_ipc,n_ocha_lens,n_cerf_onegms,n_hnrp,n_worldpop external;
```
