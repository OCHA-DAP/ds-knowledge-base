...
graph LR
  ...
  class n_moz_cholera,n_fji_storms,n_moz_cyclones,n_hti_hurricanes,n_mmr_cyclones,n_cub_hurricanes framework;
  class n_flood_gfm,n_cerf_supplement,n_floodscan_ingest,n_nhc_forecast,n_raster_stats,n_raster_pipelines,n_imerg,n_storm_impact_harmonisation,n_moz_cholera_monitoring,n_eth_drought_monitoring,n_fms_tc_outlook,n_floodexposure_monitoring,n_mdg_monitoring,n_glb_tropicalcyclones,n_afro_cholera,n_hurricanes_monitoring,n_moz_cyclones_monitoring,n_teleconnections,n_ken_drought_monitoring,n_storms_alerts,n_hti_hurricanes_monitoring,n_glb_cyclones_impactmodel,n_storms_pipeline,n_seasonal_bulletin pipeline;
  class n_seas5_viz,n_fji_storms_app,n_cerf_3rm_app,n_data_validation_app,n_seas5_skill,n_hti_hurricanes_app,n_floodexposure_monitoring_app,n_raster_stats_app app;
  class n_public_imerg,n_storms_ibtracs_tracks_geo,n_app_adm,n_storms_ecmwf_tracks_geo,n_app_floodscan_exposure,n_storms_nhc_storms,n_storms_ecmwf_storms,n_app_quantile,n_app_quantile_regions,n_public_seas5,n_public_iso3,n_storms_ibtracs_storms,n_storms_nhc_tracks_geo,n_public_polygon,n_app_admin_lookup,n_public_era5,n_public_qa,n_app_floodscan_exposure_regions table;
