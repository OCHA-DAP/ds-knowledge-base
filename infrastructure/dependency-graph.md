...
graph LR
  ...
  class n_hti_hurricanes,n_cub_hurricanes,n_fji_storms,n_mmr_cyclones,n_moz_cholera,n_moz_cyclones framework;
  class n_flood_gfm,n_storms_alerts,n_floodexposure_monitoring,n_raster_stats,n_fms_tc_outlook,n_moz_cholera_monitoring,n_hti_hurricanes_monitoring,n_nhc_forecast,n_storm_impact_harmonisation,n_afro_cholera,n_moz_cyclones_monitoring,n_ken_drought_monitoring,n_eth_drought_monitoring,n_glb_cyclones_impactmodel,n_cerf_supplement,n_hurricanes_monitoring,n_floodscan_ingest,n_storms_pipeline,n_teleconnections,n_mdg_monitoring,n_raster_pipelines,n_seasonal_bulletin,n_glb_tropicalcyclones,n_imerg pipeline;
  class n_raster_stats_app,n_seas5_viz,n_floodexposure_monitoring_app,n_cerf_3rm_app,n_seas5_skill,n_hti_hurricanes_app,n_data_validation_app,n_fji_storms_app app;
  class n_public_qa,n_app_admin_lookup,n_storms_ibtracs_tracks_geo,n_storms_ibtracs_storms,n_app_floodscan_exposure_regions,n_app_adm,n_storms_ecmwf_storms,n_public_floodscan,n_public_seas5,n_app_floodscan_exposure,n_app_quantile,n_public_era5,n_storms_nhc_tracks_geo,n_storms_nhc_storms,n_app_quantile_regions,n_storms_ecmwf_tracks_geo,n_public_imerg,n_public_iso3,n_public_polygon table;
