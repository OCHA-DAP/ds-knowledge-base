...
| [`Listmonk (comms)`](comms-listmonk.md) | infra | 12 | 16 | `afro-cholera`, `cerf-3rm-app`, `eth-drought-monitoring`, `fji-storms`, `fji-storms-app`, `fms-tc-outlook`, `ken-drought-monitoring`, `mdg-monitoring`, `mdg-storms`, `mmr-cyclones`, `moz-cholera`, `moz-cholera-monitoring`, `rosea-thresholds-monitoring`, `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
...
graph LR
  ...
  class n_lac_dry_corridor,n_mmr_cyclones,n_cub_hurricanes,n_moz_cyclones,n_mdg_storms,n_fji_storms,n_moz_cholera,n_hti_hurricanes framework;
  class n_teleconnections,n_storms_alerts,n_fms_tc_outlook,n_floodexposure_monitoring,n_ven_earthquake_support,n_glb_cyclones_impactmodel,n_raster_stats,n_hti_hurricanes_monitoring,n_seasonal_bulletin,n_imerg,n_hurricanes_monitoring,n_hdx_signals,n_flood_gfm,n_storm_impact_harmonisation,n_floodscan_ingest,n_rosea_thresholds_monitoring,n_glb_tropicalcyclones,n_mdg_monitoring,n_ken_drought_monitoring,n_moz_cholera_monitoring,n_afro_cholera,n_nhc_forecast,n_eth_drought_monitoring,n_raster_pipelines,n_storms_pipeline,n_cerf_supplement,n_moz_cyclones_monitoring pipeline;
  class n_fji_storms_app,n_hti_hurricanes_app,n_chd_ds_aa_hti_hurricanes_app,n_seas5_viz,n_geospatial_impact_exposure,n_floodexposure_monitoring_app,n_raster_stats_app,n_chd_ds_geospatial_impact_viewer,n_chd_pa_aa_nga_cholera,n_data_validation_app,n_cerf_global_trigger_allocations_app,n_seas5_skill,n_cerf_3rm_app,n_storm_exposure_compare app;
  class n_contingency_hurricanes,n_ibtracs_matching,n_fts_us_award_funding,n_nga_cholera,n_cmr_flooding_support,n_rosea_thresholds,n_som_risk_analysis_support analysis;
  class n_public_polygon,n_public_iso3,n_storms_ibtracs_tracks_geo,n_storms_nhc_storms,n_storms_ecmwf_storms,n_storms_ecmwf_tracks_geo,n_storms_ibtracs_storms,n_public_era5,n_app_quantile_regions,n_app_adm,n_app_floodscan_exposure,n_app_admin_lookup,n_public_qa,n_storms_nhc_tracks_geo,n_public_seas5,n_app_floodscan_exposure_regions,n_public_imerg,n_app_quantile,n_public_floodscan table;
  class n_listmonk,n_aws_smtp,n_dbx_job_compute infra;
  class n_ghsl,n_worldpop,n_cerf_onegms,n_ipc,n_hnrp,n_gfm_stac external;
```
