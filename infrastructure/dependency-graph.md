...
graph LR
  ...
  class n_moz_cyclones,n_mmr_cyclones,n_lac_dry_corridor,n_hti_hurricanes,n_cub_hurricanes,n_nga_flooding,n_fji_storms,n_mdg_storms,n_moz_cholera framework;
  class n_raster_pipelines,n_storms_alerts,n_ken_drought_monitoring,n_moz_cholera_monitoring,n_hurricanes_monitoring,n_rosea_thresholds_monitoring,n_teleconnections,n_eth_drought_monitoring,n_storms_pipeline,n_moz_cyclones_monitoring,n_afro_cholera,n_mdg_monitoring,n_flood_gfm,n_seasonal_bulletin,n_imerg,n_glb_tropicalcyclones,n_nga_flooding_monitoring,n_hti_hurricanes_monitoring,n_storm_impact_harmonisation,n_nhc_forecast,n_floodscan_ingest,n_raster_stats,n_glb_cyclones_impactmodel,n_hdx_signals,n_floodexposure_monitoring,n_fms_tc_outlook,n_cerf_supplement,n_ven_earthquake_support pipeline;
  class n_seas5_skill,n_cerf_global_trigger_allocations_app,n_data_validation_app,n_floodexposure_monitoring_app,n_storm_exposure_compare,n_raster_stats_app,n_geospatial_impact_exposure,n_cerf_3rm_app,n_fji_storms_app,n_hti_hurricanes_app,n_chd_ds_aa_hti_hurricanes_app,n_seas5_viz,n_chd_pa_aa_nga_cholera,n_chd_ds_geospatial_impact_viewer app;
  class n_cmr_flooding_support,n_som_risk_analysis_support,n_contingency_hurricanes,n_rosea_thresholds,n_ibtracs_matching,n_nga_cholera,n_fts_us_award_funding analysis;
  class n_public_iso3,n_storms_ibtracs_tracks_geo,n_storms_ecmwf_storms,n_storms_nhc_storms,n_app_admin_lookup,n_app_adm,n_app_quantile,n_public_seas5,n_storms_ibtracs_storms,n_storms_ecmwf_tracks_geo,n_public_polygon,n_public_era5,n_public_floodscan,n_app_quantile_regions,n_app_floodscan_exposure_regions,n_public_qa,n_app_floodscan_exposure,n_storms_nhc_tracks_geo,n_public_imerg table;
  class n_dbx_job_compute,n_listmonk,n_aws_smtp infra;
  class n_cerf_onegms,n_ipc,n_ghsl,n_gfm_stac,n_hnrp,n_worldpop external;
```
