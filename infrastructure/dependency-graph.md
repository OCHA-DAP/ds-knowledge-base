...
graph LR
  ...
  class n_cub_hurricanes,n_lac_dry_corridor,n_fji_storms,n_moz_cholera,n_hti_hurricanes,n_mmr_cyclones,n_moz_cyclones framework;
  class n_flood_gfm,n_teleconnections,n_cerf_supplement,n_raster_stats,n_moz_cyclones_monitoring,n_glb_tropicalcyclones,n_storms_pipeline,n_afro_cholera,n_seasonal_bulletin,n_fms_tc_outlook,n_raster_pipelines,n_hti_hurricanes_monitoring,n_ven_earthquake_support,n_hdx_signals,n_rosea_thresholds_monitoring,n_mdg_monitoring,n_nhc_forecast,n_storm_impact_harmonisation,n_glb_cyclones_impactmodel,n_storms_alerts,n_imerg,n_floodscan_ingest,n_eth_drought_monitoring,n_floodexposure_monitoring,n_ken_drought_monitoring,n_hurricanes_monitoring,n_moz_cholera_monitoring pipeline;
  class n_storm_exposure_compare,n_data_validation_app,n_geospatial_impact_exposure,n_seas5_viz,n_chd_ds_geospatial_impact_viewer,n_fji_storms_app,n_floodexposure_monitoring_app,n_seas5_skill,n_chd_ds_aa_hti_hurricanes_app,n_hti_hurricanes_app,n_cerf_global_trigger_allocations_app,n_cerf_3rm_app,n_raster_stats_app app;
  class n_som_risk_analysis_support,n_rosea_thresholds,n_ibtracs_matching,n_cmr_flooding_support,n_contingency_hurricanes analysis;
  class n_storms_ecmwf_tracks_geo,n_public_polygon,n_storms_nhc_storms,n_public_imerg,n_app_quantile_regions,n_public_iso3,n_app_admin_lookup,n_public_floodscan,n_public_seas5,n_storms_ibtracs_storms,n_storms_ecmwf_storms,n_storms_ibtracs_tracks_geo,n_public_qa,n_app_floodscan_exposure,n_storms_nhc_tracks_geo,n_app_adm,n_app_quantile,n_app_floodscan_exposure_regions,n_public_era5 table;
  class n_listmonk,n_dbx_job_compute,n_aws_smtp infra;
  class n_ipc,n_worldpop,n_cerf_onegms,n_gfm_stac,n_ghsl,n_hnrp external;
```
