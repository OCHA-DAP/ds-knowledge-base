...
| [`raster-pipelines`](../pipelines/raster-pipelines.md) | pipeline | 1 | 13 | `eth-drought-monitoring`, `glb-tropicalcyclones`, `mdg-monitoring`, `public.era5`, `public.imerg`, `public.qa`, `public.seas5`, `raster-stats`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `teleconnections` |
...
| [`raster-stats`](../pipelines/raster-stats.md) | pipeline | 5 | 12 | `eth-drought-monitoring`, `glb-tropicalcyclones`, `mdg-monitoring`, `public.era5`, `public.imerg`, `public.qa`, `public.seas5`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `teleconnections` |
...
graph LR
  ...
  class n_hti_hurricanes,n_mmr_cyclones,n_fji_storms,n_moz_cholera,n_moz_cyclones,n_cub_hurricanes framework;
  class n_hurricanes_monitoring,n_moz_cyclones_monitoring,n_storms_alerts,n_storms_pipeline,n_fms_tc_outlook,n_mdg_monitoring,n_eth_drought_monitoring,n_raster_pipelines,n_raster_stats,n_imerg,n_hti_hurricanes_monitoring,n_moz_cholera_monitoring,n_glb_tropicalcyclones,n_storm_impact_harmonisation,n_nhc_forecast,n_floodexposure_monitoring,n_glb_cyclones_impactmodel,n_teleconnections,n_seasonal_bulletin,n_flood_gfm,n_ken_drought_monitoring,n_floodscan_ingest,n_afro_cholera,n_cerf_supplement pipeline;
  class n_fji_storms_app,n_seas5_viz,n_seas5_skill,n_hti_hurricanes_app,n_raster_stats_app,n_cerf_3rm_app,n_floodexposure_monitoring_app,n_data_validation_app app;
  class n_storms_ecmwf_storms,n_public_era5,n_public_iso3,n_storms_nhc_storms,n_app_adm,n_storms_nhc_tracks_geo,n_app_floodscan_exposure,n_storms_ibtracs_tracks_geo,n_storms_ecmwf_tracks_geo,n_app_floodscan_exposure_regions,n_app_quantile_regions,n_app_quantile,n_public_seas5,n_public_imerg,n_app_admin_lookup,n_storms_ibtracs_storms,n_public_qa,n_public_polygon table;
...
| [`raster-stats`](../pipelines/raster-stats.md) | pipeline | `public.iso3`, `raster-pipelines` | `public.era5`, `public.imerg`, `public.qa`, `public.seas5`, `raster-stats-app` |
