...
| [`storms.gdacs_exposure`](db-schema.md#storms) | table | 3 | 4 | `cerf-3rm-app`, `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
...
| `aa.cerf_allocation` | external | 1 | 1 | `teleconnections` |
| `aa.cerf_supplement` | external | 1 | 1 | `teleconnections` |
...
| `codab` | external | 1 | 1 | `aa-drought-indicators` |
| [`emdat`](datasets/emdat.md) | external | 1 | 1 | `aa-drought-indicators` |
| [`fao-asi-vhi`](datasets/fao-asi-vhi.md) | external | 1 | 1 | `aa-drought-indicators` |
...
| [`public.floodscan`](db-schema.md#public) | table | 1 | 1 | `uga-drought-flood-2026` |
...
graph LR
  ...
  n_aa_cerf_allocation["aa.cerf_allocation"]
  n_aa_cerf_supplement["aa.cerf_supplement"]
  n_cerf_onegms["cerf-onegms"]
  n_codab["codab"]
  n_emdat["emdat"]
  n_fao_asi_vhi["fao-asi-vhi"]
  n_gfm_stac["gfm-stac"]
  n_ghsl["ghsl"]
  n_hnrp["hnrp"]
  n_ipc["ipc"]
  ...
  n_storms_adam_exposure["storms.adam_exposure"]
  n_storms_adam_fm_lookup["storms.adam_fm_lookup"]
  n_storms_admin_population["storms.admin_population"]
  n_storms_ecmwf_storms["storms.ecmwf_storms"]
  n_storms_ecmwf_tracks_geo["storms.ecmwf_tracks_geo"]
  n_storms_gdacs_exposure["storms.gdacs_exposure"]
  n_storms_gdacs_fm_lookup["storms.gdacs_fm_lookup"]
  ...
  n_storms_nhc_tracks_fcast_buffers["storms.nhc_tracks_fcast_buffers"]
  n_storms_nhc_tracks_fcast_exposure["storms.nhc_tracks_fcast_exposure"]
  n_storms_nhc_tracks_fcastonly_buffers["storms.nhc_tracks_fcastonly_buffers"]
  n_storms_nhc_tracks_fcastonly_exposure["storms.nhc_tracks_fcastonly_exposure"]
  n_storms_nhc_tracks_geo["storms.nhc_tracks_geo"]
  n_storms_nhc_tracks_obsv_buffers["storms.nhc_tracks_obsv_buffers"]
  n_storms_nhc_tracks_obsv_exposure["storms.nhc_tracks_obsv_exposure"]
  n_storms_nhc_wsp_exposure["storms.nhc_wsp_exposure"]
  n_storms_nhc_wsp_fcastonly_exposure["storms.nhc_wsp_fcastonly_exposure"]
  n_storms_nhc_wsp_fcastonly_polygon["storms.nhc_wsp_fcastonly_polygon"]
  n_storms_storm_id_lookup["storms.storm_id_lookup"]
  n_aa_tracking["aa-tracking"]
  ...
  n_nga_flooding_monitoring["nga-flooding-monitoring"]
  ...
  n_som_floods_monitoring["som-floods-monitoring"]
  ...
  n_chd_pa_aa_nga_cholera["chd-pa-aa-nga-cholera"]
  ...
  n_fao_asi_vhi --> n_aa_drought_indicators
  n_jrc_asap --> n_aa_drought_indicators
  n_raster_stats --> n_aa_drought_indicators
  n_cerf_supplement --> n_aa_tracking
  ...
  n_ocha_lens --> n_cems_flood_archive
  ...
  n_nga_cholera --> n_chd_pa_aa_nga_cholera
  ...
  n_raster_stats --> n_external_aa_frameworks_review
  ...
  n_listmonk --> n_hti_hurricanes_monitoring
  n_public_imerg --> n_hti_hurricanes_monitoring
  n_storms_pipeline --> n_hti_hurricanes_monitoring
  n_storms_admin_population --> n_hti_hurricanes_monitoring
  n_storms_ibtracs_storms --> n_hti_hurricanes_monitoring
  n_storms_nhc_storms --> n_hti_hurricanes_monitoring
  n_storms_nhc_tracks_fcastonly_exposure --> n_hti_hurricanes_monitoring
  n_storms_nhc_tracks_geo --> n_hti_hurricanes_monitoring
  n_storms_nhc_tracks_obsv_exposure --> n_hti_hurricanes_monitoring
  n_storms_nhc_wsp_fcastonly_exposure --> n_hti_hurricanes_monitoring
  ...
  n_listmonk --> n_nga_flooding
  n_nga_flooding_monitoring --> n_nga_flooding
  n_app_floodscan_exposure --> n_nga_flooding_monitoring
  n_floodexposure_monitoring --> n_nga_flooding_monitoring
  n_listmonk --> n_nga_flooding_monitoring
  ...
  n_listmonk --> n_som_floods_monitoring
  n_public_seas5 --> n_som_risk_analysis_support
  n_storm_impact_harmonisation --> n_storm_exposure_compare
  n_storms_adam_exposure --> n_storm_exposure_compare
  n_storms_gdacs_exposure --> n_storm_exposure_compare
  n_storms_nhc_tracks_fcastonly_exposure --> n_storm_exposure_compare
  n_storms_nhc_tracks_obsv_exposure --> n_storm_exposure_compare
  ...
  n_storms_adam_exposure --> n_storm_impact_harmonisation
  n_storms_gdacs_exposure --> n_storm_impact_harmonisation
  n_storms_gdacs_fm_lookup --> n_storm_impact_harmonisation
  ...
  n_storms_nhc_tracks_fcast_buffers --> n_storm_impact_harmonisation
  n_storms_nhc_tracks_fcast_exposure --> n_storm_impact_harmonisation
  n_storms_nhc_tracks_fcastonly_buffers --> n_storm_impact_harmonisation
  n_storms_nhc_tracks_fcastonly_exposure --> n_storm_impact_harmonisation
  n_storms_nhc_tracks_obsv_buffers --> n_storm_impact_harmonisation
  n_storms_nhc_tracks_obsv_exposure --> n_storm_impact_harmonisation
  n_storms_nhc_wsp_exposure --> n_storm_impact_harmonisation
  n_storms_nhc_wsp_fcastonly_exposure --> n_storm_impact_harmonisation
  n_storms_nhc_wsp_fcastonly_polygon --> n_storm_impact_harmonisation
  n_storms_storm_id_lookup --> n_storm_impact_harmonisation
  n_listmonk --> n_storms_alerts
  n_storms_pipeline --> n_storms_alerts
  n_storms_adam_exposure --> n_storms_alerts
  n_storms_adam_fm_lookup --> n_storms_alerts
  n_storms_admin_population --> n_storms_alerts
  n_storms_gdacs_exposure --> n_storms_alerts
  n_storms_gdacs_fm_lookup --> n_storms_alerts
  n_storms_ibtracs_storms --> n_storms_alerts
  n_storms_nhc_storms --> n_storms_alerts
  n_storms_nhc_tracks_fcastonly_buffers --> n_storms_alerts
  n_storms_nhc_tracks_fcastonly_exposure --> n_storms_alerts
  n_storms_nhc_tracks_geo --> n_storms_alerts
  n_storms_nhc_tracks_obsv_buffers --> n_storms_alerts
  n_storms_nhc_tracks_obsv_exposure --> n_storms_alerts
  n_storms_nhc_wsp_fcastonly_exposure --> n_storms_alerts
  n_storms_nhc_wsp_fcastonly_polygon --> n_storms_alerts
  n_storms_storm_id_lookup --> n_storms_alerts
  n_dbx_job_compute --> n_storms_pipeline
  n_storms_pipeline --> n_storms_adam_exposure
  n_storms_pipeline --> n_storms_admin_population
  n_storms_pipeline --> n_storms_ecmwf_storms
  n_storms_pipeline --> n_storms_ecmwf_tracks_geo
  n_storms_pipeline --> n_storms_gdacs_exposure
  ...
  n_storms_pipeline --> n_storms_nhc_wsp_exposure
  ...
  n_fewsnet_mirror --> n_teleconnections
  n_public_era5 --> n_teleconnections
  n_seas5_skill --> n_teleconnections
  n_public_era5 --> n_uga_drought_flood_2026
  n_public_floodscan --> n_uga_drought_flood_2026
  ...
  class n_nga_flooding,n_moz_cyclones,n_hti_hurricanes,n_fji_storms,n_mmr_cyclones,n_mdg_storms,n_moz_cholera,n_lac_dry_corridor,n_cub_hurricanes framework;
  class n_raster_stats,n_ken_drought_monitoring,n_floodexposure_monitoring,n_fewsnet_mirror,n_storms_pipeline,n_rosea_thresholds_monitoring,n_storm_impact_harmonisation,n_glb_cyclones_impactmodel,n_hurricanes_monitoring,n_flood_gfm,n_hdx_signals,n_nga_flooding_monitoring,n_fms_tc_outlook,n_afro_cholera,n_moz_cholera_monitoring,n_seasonal_bulletin,n_imerg,n_floodscan_ingest,n_glb_tropicalcyclones,n_aa_tracking,n_raster_pipelines,n_nhc_forecast,n_moz_cyclones_monitoring,n_cems_flood_archive,n_mdg_monitoring,n_ven_earthquake_support,n_hti_hurricanes_monitoring,n_storms_alerts,n_cerf_supplement,n_teleconnections,n_eth_drought_monitoring,n_som_floods_monitoring pipeline;
  class n_chd_ds_aa_hti_hurricanes_app,n_seas5_viz,n_floodexposure_monitoring_app,n_hti_hurricanes_app,n_storm_exposure_compare,n_cerf_3rm_app,n_chd_pa_aa_nga_cholera,n_fji_storms_app,n_cerf_global_trigger_allocations_app,n_seas5_skill,n_data_validation_app,n_raster_stats_app,n_chd_ds_geospatial_impact_viewer,n_geospatial_impact_exposure app;
  class n_uga_drought_flood_2026,n_rosea_thresholds,n_fts_us_award_funding,n_contingency_hurricanes,n_ibtracs_matching,n_external_aa_frameworks_review,n_som_risk_analysis_support,n_cmr_flooding_support,n_nga_cholera,n_aa_drought_indicators analysis;
  class n_storms_gdacs_fm_lookup,n_storms_nhc_wsp_exposure,n_public_floodscan,n_app_admin_lookup,n_storms_ibtracs_storms,n_public_era5,n_public_imerg,n_storms_nhc_storms,n_storms_nhc_wsp_fcastonly_polygon,n_storms_ecmwf_storms,n_storms_nhc_wsp_fcastonly_exposure,n_public_seas5,n_storms_storm_id_lookup,n_app_quantile_regions,n_storms_admin_population,n_public_qa,n_storms_nhc_tracks_fcastonly_buffers,n_public_polygon,n_app_adm,n_storms_ecmwf_tracks_geo,n_storms_nhc_tracks_obsv_exposure,n_storms_ibtracs_tracks_geo,n_storms_nhc_tracks_fcast_buffers,n_storms_gdacs_exposure,n_app_floodscan_exposure_regions,n_storms_nhc_tracks_obsv_buffers,n_app_quantile,n_storms_nhc_tracks_fcastonly_exposure,n_storms_adam_fm_lookup,n_public_iso3,n_storms_nhc_tracks_geo,n_storms_adam_exposure,n_storms_nhc_tracks_fcast_exposure,n_app_floodscan_exposure table;
  class n_aws_smtp,n_listmonk,n_dbx_job_compute infra;
  class n_fao_asi_vhi,n_worldpop,n_ocha_lens,n_codab,n_cerf_onegms,n_aa_cerf_allocation,n_gfm_stac,n_hnrp,n_ipc,n_ghsl,n_emdat,n_aa_cerf_supplement,n_jrc_asap external;
```
...
| `codab` | external | — | `aa-drought-indicators` |
| [`emdat`](datasets/emdat.md) | external | — | `aa-drought-indicators` |
| [`fao-asi-vhi`](datasets/fao-asi-vhi.md) | external | — | `aa-drought-indicators` |
| `gfm-stac` | external | — | `flood-gfm` |
| [`ghsl`](datasets/ghsl.md) | external | — | `flood-gfm`, `ven-earthquake-support` |
| [`hnrp`](datasets/hnrp.md) | external | — | `fts-us-award-funding`, `geospatial-impact-exposure` |
...
| [`app.floodscan_exposure`](db-schema.md#app) | table | `floodexposure-monitoring` | `floodexposure-monitoring`, `floodexposure-monitoring-app`, `nga-flooding-monitoring` |
...
| [`public.floodscan`](db-schema.md#public) | table | `raster-stats` | `uga-drought-flood-2026` |
...
| [`public.seas5`](db-schema.md#public) | table | `raster-stats` | `eth-drought-monitoring`, `raster-stats-app`, `seas5-skill`, `seas5-viz`, `seasonal-bulletin`, `som-risk-analysis-support`, `uga-drought-flood-2026` |
| [`storms.adam_exposure`](db-schema.md#storms) | table | `storms-pipeline` | `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
| [`storms.adam_fm_lookup`](db-schema.md#storms) | table | — | `storms-alerts` |
| [`storms.admin_population`](db-schema.md#storms) | table | `storms-pipeline` | `hti-hurricanes-monitoring`, `storms-alerts` |
...
| [`storms.gdacs_exposure`](db-schema.md#storms) | table | `storms-pipeline` | `storm-exposure-compare`, `storm-impact-harmonisation`, `storms-alerts` |
| [`storms.gdacs_fm_lookup`](db-schema.md#storms) | table | — | `storm-impact-harmonisation`, `storms-alerts` |
| [`storms.ibtracs_storms`](db-schema.md#storms) | table | `storms-pipeline` | `cerf-supplement`, `glb-tropicalcyclones`, `hti-hurricanes-monitoring`, `storm-impact-harmonisation`, `storms-alerts` |
...
| [`storms.nhc_wsp_fcastonly_exposure`](db-schema.md#storms) | table | `storms-pipeline` | `hti-hurricanes-monitoring`, `storm-impact-harmonisation`, `storms-alerts` |
| [`storms.nhc_wsp_fcastonly_polygon`](db-schema.md#storms) | table | `storms-pipeline` | `storm-impact-harmonisation`, `storms-alerts` |
| [`storms.storm_id_lookup`](db-schema.md#storms) | table | `storms-pipeline` | `storm-impact-harmonisation`, `storms-alerts` |
| [`aa-tracking`](../pipelines/aa-tracking.md) | pipeline | `cerf-supplement` | — |
...
| [`nga-flooding-monitoring`](../pipelines/nga-flooding-monitoring.md) | pipeline | `app.floodscan_exposure`, `floodexposure-monitoring`, `listmonk` | `nga-flooding` |
...
| [`raster-stats`](../pipelines/raster-stats.md) | pipeline | `dbx-job-compute`, `public.iso3`, `raster-pipelines` | `aa-drought-indicators`, `external-aa-frameworks-review`, `public.era5`, `public.floodscan`, `public.imerg`, `public.iso3`, `public.polygon`, `public.qa`, `public.seas5`, `raster-stats-app`, `uga-drought-flood-2026` |
...
| [`storms-pipeline`](../pipelines/storms-pipeline.md) | pipeline | `dbx-job-compute` | `cerf-supplement`, `contingency-hurricanes`, `hti-hurricanes-monitoring`, `hurricanes-monitoring`, `ibtracs-matching`, `storm-impact-harmonisation`, `storms-alerts`, `storms.adam_exposure`, `storms.admin_population`, `storms.ecmwf_storms`, `storms.ecmwf_tracks_geo`, `storms.gdacs_exposure`, `storms.ibtracs_storms`, `storms.ibtracs_tracks_geo`, `storms.nhc_storms`, `storms.nhc_tracks_geo`, `storms.nhc_wsp_exposure`, `storms.nhc_wsp_fcastonly_exposure`, `storms.nhc_wsp_fcastonly_polygon`, `storms.storm_id_lookup` |
...
| [`chd-pa-aa-nga-cholera`](../apps/chd-pa-aa-nga-cholera.md) | app | `nga-cholera` | — |
...
| [`seas5-skill`](../apps/seas5-skill.md) | app | `public.era5`, `public.seas5` | `teleconnections` |
| [`seas5-viz`](../apps/seas5-viz.md) | app | `public.era5`, `public.polygon`, `public.seas5` | — |
| [`storm-exposure-compare`](../apps/storm-exposure-compare.md) | app | `storm-impact-harmonisation`, `storms.adam_exposure`, `storms.gdacs_exposure`, `storms.nhc_tracks_fcastonly_exposure`, `storms.nhc_tracks_obsv_exposure` | — |
| [`aa-drought-indicators`](../analysis/aa-drought-indicators.md) | analysis | `cerf-supplement`, `codab`, `emdat`, `fao-asi-vhi`, `jrc-asap`, `raster-stats` | — |
...
| [`external-aa-frameworks-review`](../analysis/external-aa-frameworks-review.md) | analysis | `raster-stats` | — |
| [`fts-us-award-funding`](../analysis/fts-us-award-funding.md) | analysis | `hnrp` | — |
| [`ibtracs-matching`](../analysis/ibtracs-matching.md) | analysis | `storms-pipeline` | — |
| [`nga-cholera`](../analysis/nga-cholera.md) | analysis | — | `chd-pa-aa-nga-cholera` |
...
| [`mdg-storms`](../frameworks/mdg-storms/) | framework | `mdg-monitoring` | — |
