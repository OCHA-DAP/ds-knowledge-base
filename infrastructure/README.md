...
- [licensing.md](licensing.md) — **not decided**: captured discussion on repo/content licensing (most public repos have no license; Apache-2.0 + CC BY + NOTICE trademark line proposed, nothing implemented)
