...
| `nhc_tracks_geo` | 212.8k | 95.7 MB | <details><summary>20 cols</summary>atcf_id `character varying`, provider `character varying`, basin `character varying`, issued_time `timestamp without time zone`, valid_time `timestamp without time zone`, leadtime `integer`, wind_speed `real`, pressure `real`, max_wind_radius `integer`, last_closed_isobar_radius `integer`, last_closed_isobar_pressure `integer`, gust_speed `integer`, nature `character varying`, quadrant_radius_34 `text`, quadrant_radius_50 `text`, quadrant_radius_64 `text`, number `character varying`, storm_id `character varying`, point_id `character varying`, geometry `USER-DEFINED`</details> |
| `nhc_wsp_fcastonly_polygon` | 677 | 4.2 MB | <details><summary>7 cols</summary>id `bigint`, issued_time `timestamp without time zone`, wind_threshold_kt `smallint`, percentage `smallint`, atcf_id `character varying`, obsv_valid_time `timestamp without time zone`, geometry `USER-DEFINED`</details> |
| `nhc_wsp_polygon_matched` | 677 | 4.0 MB | <details><summary>6 cols</summary>id `bigint`, issued_time `timestamp without time zone`, wind_threshold_kt `smallint`, percentage `smallint`, atcf_id `character varying`, geometry `USER-DEFINED`</details> |
| `nhc_wsp_polygon_raw` | 297 | 3.9 MB | <details><summary>5 cols</summary>id `bigint`, issued_time `timestamp without time zone`, wind_threshold_kt `smallint`, percentage `smallint`, geometry `USER-DEFINED`</details> |
...
| `nhc_tracks_fcast_buffers` | 51 | 2.7 MB | <details><summary>4 cols</summary>atcf_id `character varying`, issued_time `timestamp without time zone`, wind_speed_kt `smallint`, geometry `USER-DEFINED`</details> |
| `nhc_tracks_fcastonly_buffers` | 51 | 2.6 MB | <details><summary>4 cols</summary>atcf_id `character varying`, issued_time `timestamp without time zone`, wind_speed_kt `smallint`, geometry `USER-DEFINED`</details> |
| `nhc_tracks_obsv_buffers` | 51 | 1.3 MB | <details><summary>4 cols</summary>atcf_id `character varying`, valid_time `timestamp without time zone`, wind_speed_kt `smallint`, geometry `USER-DEFINED`</details> |
...
| `nhc_wsp_exposure` | 863 | 240.0 KB | <details><summary>8 cols</summary>issued_time `timestamp without time zone`, wind_threshold_kt `smallint`, percentage `smallint`, atcf_id `character varying`, admin_level `smallint`, iso3 `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
| `nhc_wsp_fcastonly_exposure` | 812 | 240.0 KB | <details><summary>8 cols</summary>issued_time `timestamp without time zone`, wind_threshold_kt `smallint`, percentage `smallint`, atcf_id `character varying`, admin_level `smallint`, iso3 `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
| `adam_exposure` | 389 | 208.0 KB | <details><summary>10 cols</summary>adam_eventid `integer`, adam_episodeid `integer`, valid_time `timestamp without time zone`, wind_speed_kt `smallint`, admin_level `smallint`, iso3 `character varying`, admin_name `character varying`, parent_admin_name `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
...
| `storm_id_lookup` | 7 | 104.0 KB | <details><summary>5 cols</summary>gdacs_eventid `integer`, atcf_id `character varying`, sid `character varying`, adam_eventid `integer`, last_updated `timestamp without time zone`</details> |
| `nhc_tracks_fcast_exposure` | 63 | 96.0 KB | <details><summary>7 cols</summary>atcf_id `character varying`, issued_time `timestamp without time zone`, wind_speed_kt `smallint`, admin_level `smallint`, iso3 `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
| `nhc_tracks_fcastonly_exposure` | 65 | 96.0 KB | <details><summary>7 cols</summary>atcf_id `character varying`, issued_time `timestamp without time zone`, wind_speed_kt `smallint`, admin_level `smallint`, iso3 `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
| `exposure_completion` | 108 | 64.0 KB | <details><summary>4 cols</summary>out_table `text`, key_val `timestamp without time zone`, admin_level `integer`, completed_at `timestamp without time zone`</details> |
| `nhc_tracks_obsv_exposure` | ? | 48.0 KB | <details><summary>7 cols</summary>atcf_id `character varying`, valid_time `timestamp without time zone`, wind_speed_kt `smallint`, admin_level `smallint`, iso3 `character varying`, pcode `character varying`, pop_exposed `integer`</details> |
