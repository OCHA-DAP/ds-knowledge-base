...
| Page | What it's for |
|---|---|
| **[USING.md](USING.md)** | *For team members* — pointing Claude at the KB: the `ds-team` plugin marketplace, MCP connectors, the chatbot, worktree discipline, what's where. |
...
| **[I18N.md](I18N.md)** | *Multilingual public sites* — the EN/FR toggle mechanism (D86), the French AA glossary, adding a language. |
