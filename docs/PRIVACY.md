...
ds-knowledge-base/                       ← PUBLIC repo (git, GitHub Pages)
  ...
  raw/frameworks/<fw>/<ver>.captions.txt Claude vision captions of those PDFs' visuals      ← public
  raw/.pdf-cache/                        cached source PDFs (public docs; deliberately committed, #250) ← public
