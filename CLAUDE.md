...
- `assets/` — blob **data-coverage** reports, one page per project × datasource ("what do we have stored, and is it sufficient?"), generated by `scripts/gen_blob_inventory.py` (D72).
