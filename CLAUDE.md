...
- **[docs/I18N.md](docs/I18N.md)** — *multilingual public sites*: the EN/FR toggle mechanism (`scripts/site_i18n.py`, D86), the doc-sourced French AA glossary, and how to reuse it on other sites / add a language. Read before touching UI strings in the AA-site generators.
