...
- **[docs/USING.md](docs/USING.md)** — *for team members*: pointing Claude Code at the KB (manual global pointer + MCP connectors; the one-command setup is retired pending PR #221), the chatbot, and where things are.
