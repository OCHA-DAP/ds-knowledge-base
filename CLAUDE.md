...
- `infrastructure/libs/` — reference pages for the shared Python libraries (`ocha-stratus/lens/relay`, `ds-toolkit`, `ocha-mailchimp`; `ocha-anticipy` is **deprecated**, page kept for reading old code): purpose, install + auth, key API, used-by.
