...
see `external-frameworks/README.md`). Hub listing: 2022: Drought (FAO) [FAO]; 2023: Drought (FAO) [FAO]; 2024: Drought (FAO) [FAO].

## Sources
- [Anticipation Hub global map](https://www.anticipation-hub.org/experience/global-map) (inventory record, fetched 2026-07-10)
- [Framework document](https://ap-plat-ccca.nies.go.jp/adaptation-database/list/case-study?id=1335&cat%5B0%5D=1)
