...
see `external-frameworks/README.md`). Hub listing: 2023: Dzud (FAO) [FAO] [Government of Mongolia]; 2024: Dzud (FAO) [FAO].

## Sources
- [Anticipation Hub global map](https://www.anticipation-hub.org/experience/global-map) (inventory record, fetched 2026-07-10)
- [Framework document](/download/file-4045)
