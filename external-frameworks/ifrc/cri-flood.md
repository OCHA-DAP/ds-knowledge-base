...
funding_by_source: {}
target_people: 10000
framework_doc: /download/file-3672
...
see `external-frameworks/README.md`). Hub listing: 2023: Flood (IFRC) [Costa Rican Red Cross]; 2024: Flood (IFRC) [Costa Rican Red Cross].

## Sources
- [Anticipation Hub global map](https://www.anticipation-hub.org/experience/global-map) (inventory record, fetched 2026-07-10)
- [Framework document](/download/file-3672)
