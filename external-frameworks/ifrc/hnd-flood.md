...
see `external-frameworks/README.md`). Hub listing: 2023: Flood (IFRC) [Honduran Red Cross]; 2024: Flood (IFRC) [Honduran Red Cross].

## Sources
- [Anticipation Hub global map](https://www.anticipation-hub.org/experience/global-map) (inventory record, fetched 2026-07-10)
- [Framework document](/download/file-4519)
