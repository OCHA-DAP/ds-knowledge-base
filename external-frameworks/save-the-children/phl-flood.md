...
see `external-frameworks/README.md`). Hub listing: 2024: Flood (Save the Children) [Save the Children].

## Sources
- [Anticipation Hub global map](https://www.anticipation-hub.org/experience/global-map) (inventory record, fetched 2026-07-10)
- [Framework document](https://www.savethechildren.org.ph/where-we-are/article/flood-anticipatory-action-in-tanay-rizal-flair/)
