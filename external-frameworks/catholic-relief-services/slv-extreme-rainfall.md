...
> **Not an OCHA/CERF framework.** This is Catholic Relief Services's anticipatory-action framework, catalogued here for cross-organisation comparison ([why](../README.md)). OCHA's own SLV framework(s): [lac-dry-corridor](../../frameworks/lac-dry-corridor/README.md).
