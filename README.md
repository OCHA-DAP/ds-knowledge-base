...
> **Looking for a dashboard, app or published analysis?** → **[The team hub](https://ocha-dap.github.io/ds-knowledge-base/)** — every one the team runs, on one page, with thumbnails; filter by hazard, country or hosting. Generated from this KB, so it tracks what is actually deployed.
...
| [`apps/`](apps/) | Deployed interactive surfaces (marimo / Dash / Quarto) on Azure / GH Pages — all of them, plus every other published site, are cards on the [team hub](https://ocha-dap.github.io/ds-knowledge-base/) |
