...
def build_pr_context(pr: dict, num: str) -> str:
    ...
    return (
        ...
        "  This bar is HIGHER on someone else's PR: \"what do you think?\" — even about specific\n"
        "  proposed changes — wants your ASSESSMENT, not commits pushed to their branch. Push to\n"
        "  another person's branch only when their comment explicitly asks you to make the change\n"
        "  (\"apply these\", \"fix the conflicts\", \"go ahead\"). When in doubt, reply with what you\n"
        "  WOULD change and ask.\n"
